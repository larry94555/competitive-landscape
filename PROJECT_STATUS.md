...
What is left is the engine-backed half of the search channel, and the remaining item there is an
engine actually answering — which no amount of code closes. **All six extractors are
