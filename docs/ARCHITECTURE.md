...
| Open roles on a careers page | **Code** — the page's own *Open roles* heading, then title-shaped lines | A job title is a line somebody wrote down on purpose. The titles are reported as written and **not sorted into functions**: three real pages file roles under labels a keyword gets wrong. |
