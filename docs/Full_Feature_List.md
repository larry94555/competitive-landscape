...
**As of 2026-08-07** · `main` at `72ce045` · **47 of 130 PRs · 36% of the software deliverable**
...
| [**S2**](#s2--ready-for-demonstration) | Any business idea handled correctly | 18 | 7 | **11** | **39%** |
...
*Any business idea handled correctly, limited functionality, friendly users only.* **A business
idea produces a comparison now.** Seven of eighteen rows are done. The headline of this state —
*"a business idea does not run at all"* — stopped being true two rows ago, and what a description
produces stopped being **one** company with this one: it is the set, best first, each member
carrying the count of searches that returned it and the words its own front page shares with what
was typed.
...
| Competitor set derivation — one idea to several companies, with why each was chosen | S2 | 3 | 1 | **2** | 33% |
